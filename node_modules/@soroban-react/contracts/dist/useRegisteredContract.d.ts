 ...
 */
export declare const useWrappedContract: (deploymentInfo: ContractDeploymentInfo | undefined) => WrappedContract | undefined;
/**
 ...
 * @returns The `WrappedContract` object.
 */
export declare const useRegisteredContract: (contractId: string) => WrappedContract | undefined;
